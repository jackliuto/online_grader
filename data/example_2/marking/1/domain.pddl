...
(define (domain Rover)
    ...
    (:predicates
        ...
        (domain2_full ?x1 - store ?x2 - rover)
    ...
    (:action drop
     ...
     :precondition (and (and (domain1_store_of ?y ?x) (domain1_full ?y)) (and (domain2_store_of ?y ?x) (domain2_full ?y ?x)))
     :effect (and
        (not (domain1_full ?y))
        (domain1_empty ?y)
        (not (domain2_full ?y ?x))
        (domain2_empty ?y))
    )
    ...
    (:action fail_drop1
     :parameters (?x - rover ?y - store)
     :precondition (and (not (and (domain2_store_of ?y ?x) (domain2_full ?y ?x))) (and (domain1_store_of ?y ?x) (domain1_full ?y)))
     :effect (and
        (failed ))
    )
    ...
    (:action fail_drop2
     :parameters (?x - rover ?y - store)
     :precondition (and (not (and (domain1_store_of ?y ?x) (domain1_full ?y))) (and (domain2_store_of ?y ?x) (domain2_full ?y ?x)))
     :effect (and
        (failed ))
    )
